  ...
  return (
    <div className="min-h-screen flex items-center justify-around bg-white">
      ...
      >
        ...
        <div className="mb-10">
          <label htmlFor="username" className="block text-left text-sm font-medium text-gray-700 mb-3">
            Username
          </label>
          <input
            id="username"
        ...
        <div className="mb-10">
          <label htmlFor="email" className="block text-left text-sm font-medium text-gray-700 mb-3">
            Email
          </label>
          <input
            id="email"
        ...
        <div className="mb-10">
          <label htmlFor="password" className="block text-left text-sm font-medium text-gray-700 mb-3">
            Password
          </label>
          <input
            id="password"
        ...
        <button
          type="submit"
          className="w-full cursor-pointer bg-[rgb(108,99,255)] hover:bg-[rgb(86,79,204)] text-white font-semibold py-2 rounded-lg transition duration-300"
        >
          Sign Up
        </button>
        <p className=' mt-3 hover:text-[rgb(86,79,204)] cursor-pointer text-center ' onClick={()=>navigate('/')} >Go Home</p>
      </form>
    </div>
  )
}
